...
const Content = /* #__PURE__ */function (_Component) {
  _inherits(Content, _Component);

  const _super = _createSuper(Content);
...
_defineProperty(Content, "propTypes", {
  ...
  contentDidMount: _propTypes.default.func.isRequired,
  contentDidUpdate: _propTypes.default.func.isRequired
});