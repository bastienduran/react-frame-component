...
const _Content = _interopRequireDefault(require("./Content"));
...
const Frame = /* #__PURE__ */function (_Component) {
  _inherits(Frame, _Component);

  const _super = _createSuper(Frame);
  ...
  function Frame(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleLoad", () => {
      _this.forceUpdate();
    });
  ...
  _createClass(Frame, [{
    ...
    value: function renderFrameContents() {
      ...
      const contents = /* #__PURE__ */_react.default.createElement(_Content.default, {
        contentDidMount,
        contentDidUpdate
